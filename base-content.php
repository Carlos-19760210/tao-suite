...
<aside class="cbpm-sidebar">
  ...
  <nav>
    ...
    if ( $is_master ) {
        ...
        $crm_cfg_slugs   = function_exists('tao_crm_page_kanban') ? ['tao-crm-settings'] : [];
        cbpm_nav_section_group('sec-cfg', 'Configurações', function() use ($page_atual, $geral_cfg_slugs, $neo_cfg_slugs, $crm_cfg_slugs) {
            cbpm_nav_group('cfg-geral', 'Geral', function() use ($page_atual) {
                cbpm_nav_item('chatbot-platform',               ['icon'=>'&#x1F3E2;','label'=>'Negócios',        'url'=>cbpm_url('negocios')],      $page_atual);
                cbpm_nav_item('chatbot-platform-usuarios',      ['icon'=>'&#x1F465;','label'=>'Usuários',        'url'=>cbpm_url('usuarios')],      $page_atual);
                cbpm_nav_item('chatbot-platform-conectores',    ['icon'=>'&#x1F517;','label'=>'Conectores',      'url'=>cbpm_url('conectores')],    $page_atual);
                cbpm_nav_item('chatbot-platform-settings',      ['icon'=>'&#x2699;', 'label'=>'Configurações',   'url'=>cbpm_url('configuracoes')], $page_atual);
            ...
            cbpm_nav_group('cfg-neo', 'TAO NEO', function() use ($page_atual) {
                ...
                cbpm_nav_item('chatbot-platform-catalogo',        ['icon'=>'&#x1F4CB;','label'=>'Catálogo',       'url'=>cbpm_url('catalogo')],       $page_atual);
                cbpm_nav_item('chatbot-platform-disponibilidade', ['icon'=>'&#x1F4C5;','label'=>'Disponibilidade','url'=>cbpm_url('disponibilidade')], $page_atual);
                cbpm_nav_item('chatbot-platform-conteudo',        ['icon'=>'&#x1F4E2;','label'=>'Promoções',      'url'=>cbpm_url('conteudo')],       $page_atual);
    ...
    if ( $is_gestor ) {
        ...
        cbpm_nav_section_group('sec-cfg-g', 'Configurações', function() use ($page_atual, $gestor_cfg_slugs) {
            cbpm_nav_group('cfg-gestor', 'Meu Negócio', function() use ($page_atual) {
                cbpm_nav_item('chatbot-platform',               ['icon'=>'&#x1F3E2;','label'=>'Configurações',   'url'=>cbpm_url('negocios')],      $page_atual);
                cbpm_nav_item('chatbot-platform-categorias',    ['icon'=>'&#x1F3F7;','label'=>'Categorias',      'url'=>cbpm_url('categorias')],    $page_atual);
                cbpm_nav_item('chatbot-platform-campos-extras', ['icon'=>'&#x1F9E9;','label'=>'Campos Extras',   'url'=>cbpm_url('campos-extras')], $page_atual);
                cbpm_nav_item('chatbot-platform-catalogo',        ['icon'=>'&#x1F4CB;','label'=>'Catálogo',       'url'=>cbpm_url('catalogo')],       $page_atual);
                cbpm_nav_item('chatbot-platform-disponibilidade', ['icon'=>'&#x1F4C5;','label'=>'Disponibilidade','url'=>cbpm_url('disponibilidade')], $page_atual);
