...
function tao_formula_page_orcamento_novo() {
            ...
            <tr>
                ...
                <td>
                    <input type="number" id="taof-acrescimo-pct" name="acrescimo_pct"
                           value="0" min="0" max="500" step="0.1" class="taof-pct-inp"> %
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="number" id="taof-desconto-pct" name="desconto_pct"
                           value="0" min="0" max="100" step="0.1" class="taof-pct-inp"> %
                </td>
    ...
    .taof-ac-item {
        ...
        border-bottom:1px solid #f8fafc; line-height:1.3;
    }
    .taof-ac-item:hover { background:#f0f9ff; }
    .taof-ac-item:last-child { border-bottom:none; }
    .taof-ac-item small { display:block; color:#94a3b8; font-size:11px; margin-top:2px; }
