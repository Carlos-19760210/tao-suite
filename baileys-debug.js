    ...
    constructor(configService, eventEmitter, repository, cache, chatwootCache, baileysCache, providerFiles) {
        ...
        this.messageHandle = {
            ...
            'messages.upsert': ({ messages, type, }, database, settings) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    process.stdout.write('TAO_DEBUG upsert type=' + type + ' count=' + messages.length + '\n');
                    ...
                    for (const received of messages) {
                        ...
                        process.stdout.write('TAO_DEBUG msg jid=' + received.key.remoteJid + ' type=' + type + ' hasMsg=' + !!received.message + '\n');
                        if ((type !== 'notify' && type !== 'append') ||
                            ...
                            process.stdout.write('TAO_DEBUG REJECTED type=' + type + ' jid=' + received.key.remoteJid + '\n');
                        ...
                        process.stdout.write('TAO_DEBUG pre-webhook enabled=' + this.localWebhook.enabled + ' url=' + this.localWebhook.url + ' events=' + JSON.stringify(this.localWebhook.events) + '\n');
                        this.logger.log(messageRaw);
                        this.logger.verbose('Sending data to webhook in event MESSAGES_UPSERT');
                        this.sendDataWebhook(wa_types_1.Events.MESSAGES_UPSERT, messageRaw);
                        process.stdout.write('TAO_DEBUG post-sendDataWebhook\n');
